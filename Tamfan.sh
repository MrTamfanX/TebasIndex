...
echo
echo
toilet -f future "    Auto TebasIndex" | lolcat
echo
echo $red"##########################$green" WELCOME "$red###########################"
echo $yellow
figlet -f future "MrTamfanX Cyber Team"
echo
echo $red"##########################$green" WELCOME "$red###########################"
echo
...
echo $indigo"=============================================================="
echo
echo $white "╭─"$yellow"MrTamfanX@Tebas404"$cyan" ~/MrTamfanX"$white
read -p " ╰─$ "  apaan
echo
if [ $apaan = "A" ] || [ $apaan = "a" ]
then
...
echo $green "╭─"$blue"MrTamfanX@Tebas404"$cyan" ~/MrTamfanX"$white
read -p " ╰─$ "  target
echo
echo $red "Masukan Script!!! "
echo $green "╭─"$blue"MrTamfanX@Tebas404"$cyan" ~/Nama SC Harus(index.html)"$white
read -p " ╰─$ "  script
...
echo
echo "Masukan Script !!!!"
echo $white "╭─"$green"MrTamfanX@Tebas404"$cyan" ~/MrTamfanX"$white                               
read -p " ╰─$ " script
echo
echo
echo $white"Masukan Target1 !!!!"
echo $white "╭─"$green"MrTamfanX@Tebas404"$cyan" ~/Crot"$white
read -p " ╰─$ " target1
...
echo $red"##########################$green" WELCOME "$red###########################"
echo $green"Author  : MrTamfanX			"
echo $purple"Gthub   : https://github.com/MrTamfanX/TebasIndex"
echo $white"Blog    : https://linkduit.net/FmJIa"
echo
echo $yellow"                          THANKS TO :"
echo
echo $cyan"[+] MrTamfanX Cyber Team "
echo $cyan"[+] MrTamfanX "
echo $cyan"[+] MrTamfanX Cyber Team & All Member [M.C.T] "
echo $red"##########################$green" WELCOME "$red###########################"
